...
public class Item {
    ...
    public void setIntAtt(ArrayList<Long> intAtt) {
        IntAtt = new ArrayList<>(intAtt);
    }

    public void setDoubleAtt(ArrayList<Double> doubleAtt) {
        DoubleAtt = new ArrayList<>(doubleAtt);
    }

    public void setStringAtt(ArrayList<String> stringAtt) {
        StringAtt = new ArrayList<>(stringAtt);
    }

    public void setCategoricalAtt_Psc_bits(ArrayList<BitSet> categoricalAtt_Psc_bits) {
        CategoricalAtt_Psc_bits = new ArrayList<>(categoricalAtt_Psc_bits);
    }

    public void setCatAttr(HashMap<Integer, ArrayList<String>> catAttr) {
        CatAttr = new HashMap<>(catAttr);
    }

    public void setDateAtt(ArrayList<LocalDate> dateAtt) {
        DateAtt = new ArrayList<>(dateAtt);
    }

    public void setBooleanAtt(ArrayList<String> booleanAtt) {
        BooleanAtt = new ArrayList<>(booleanAtt);
    }

    public void setWordFrequencies(LinkedHashMap<Integer,HashMap<String,Integer>> wordFrequencies){
        this.wordFrequencies = new LinkedHashMap<>(wordFrequencies);
    }
